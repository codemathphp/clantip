...
import { Menu, X, Home, Gift, History, Settings, LogOut, ChevronRight, ShoppingBag, Wallet as WalletIcon } from 'lucide-react'
  ...
  const handleGiftCredits = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (paymentMethod === 'balance') {
        ...
        toast.success(`Gift sent! Recipient: ${resolvedHandle || resolvedPhone}`)
